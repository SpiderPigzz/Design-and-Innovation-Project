...
export function RecommendedItemCard() {
    return (
        ...
        <Card style={[styles.cardSec, { marginHorizontal: 20, marginTop: 4,
            paddingVertical: 0,
            paddingHorizontal: 0,
            alignContent:'center'
            }]}>
            ...
            <Image source={require('../../assets/food-sample-image.jpeg')} style={[styles.imageIcon, {width: 50, height:50, borderRadius: 2}]}></Image>
            <Text style={[styles.infoText, {fontSize:10, color:'grey'}]}>{'\n\n\n'} S$4.50</Text>
