        ...
        <Card style={styles.cardSec}>
            <View>
                ...
                <View style={{ marginVertical: 1, marginLeft: 2 , marginTop: 5}}>
                    ...
                    <ImageBackground style={[styles.Image, { justifyContent: 'center'},{alignSelf:'center'}]} imageStyle={{ borderRadius: 10 }} source={require('../../assets/images/takagiramenH.png')}>
