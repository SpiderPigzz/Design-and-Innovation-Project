        ...
        <Card style={styles.cardSec}>
            <View>
                <View style={{ marginTop: 5}}>
                    ...
                    <ImageBackground style={[styles.Image, { marginLeft:20},{alignSelf:'center'}]} imageStyle={{ borderRadius: 3 }} source={require('../../assets/images/ichibanjp.png')}>
                    </ImageBackground>
                </View>
